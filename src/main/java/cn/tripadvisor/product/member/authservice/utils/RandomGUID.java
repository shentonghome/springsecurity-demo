...
public class RandomGUID {
    ...
    static {
        ...
        try {
            s_id = InetAddress.getLocalHost().getHostName();
    ...
    /** Convert the standard format for a GUID sans the dashes
     *
     * @author nshanny@tripadvisor.com
     * @date   Mon Jun 10 17:57:27 2002
     */
    ...
    public static void main(String[] args) {
        String string = new RandomGUID().toStrippedString();
